...
Cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     $ // 'set1_XCSNAMEX370.dat')
       PARAMETER(FNCOF2=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'set2_XCSNAMEX370.dat')
       PARAMETER(FNCOF3=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'set3_XCSNAMEX370.dat')
       PARAMETER(FNCOF4=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'set4_XCSNAMEX370.dat')
       PARAMETER(FNCOF5=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'set5_XCSNAMEX370.dat')
       PARAMETER(FNCOF6=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'set6_XCSNAMEX370.dat')
       PARAMETER(FNCOF7=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'set7_XCSNAMEX370.dat')
       PARAMETER(FNCO2 =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'CO2_5term_XCSNAMEX370.dat')
       PARAMETER(FNSO2 =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'SO2_XCSNAMEX370.dat')
       PARAMETER(FNHNO3 =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'HNO3_XCSNAMEX370.dat')
       PARAMETER(FNN2O =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'N2O_XCSNAMEX370.dat')
       PARAMETER(FNOPTR=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'optran_XCSNAMEX370.dat')
       PARAMETER(FNTHER=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'therm_XCSNAMEX370.dat')
       PARAMETER(FNCOFN=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
