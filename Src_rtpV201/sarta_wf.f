...
C    "wf" variant for weighting function calculation
!F77====================================================================
...
C 31 Jan 2011 Scott Hannon   Dump layer effective TAU to output for
C                               use in weighting function calculation
...
ccc This block of code for "wf" variant"
       OPEN(UNIT=10,FILE='WF.DAT',FORM='UNFORMATTED',STATUS='NEW')
ccc
