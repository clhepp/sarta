...
C 09 May 2008 Scott Hannon      Add YOFF
...
C      Read YOFF (grating model y-offset)
       IF (PROF.freqcal .LT. YOFMIN .OR. PROF.freqcal .GT. YOFMAX) THEN
          YOFF=YOFDEF
ccc maybe a bad idea to change the value
c          PROF.freqcal=YOFDEF
ccc
       ELSE
          YOFF=PROF.freqcal
       ENDIF
