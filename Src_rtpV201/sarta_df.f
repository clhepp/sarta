...
C 04 Aug 2009 Scott Hannon   Add call to SPECCAL; add DFCAL; add
C                               CLI<gas> for CO2,HNO,H2O,N2O,SO2 to
C                               RDCOEF & TUNMLT calls; add CLI<*> to
C                               SUMCOF call; adjust head.vchan
C 06 Aug 2009 Scott Hannon   Remove NCHAN and INDCHAN from SPECCAL call
...
C      ---------------------------------
C      Read the spec cal adjustment file
C      ---------------------------------
...
C
C            Check old channel freqs before updating
