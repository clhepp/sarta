...
!CALL PROTOCOL
C    note: call is identical to RDCOEF_nte
C    TUNMLT ( IOUN, NCHAN, INDCHN, SETCHN,
...
C       INDHNO, COFHNO, INDN2O, COFN2O, INDH2O, WAZOP, WAVGOP,
C       COFH2O, FX, NCHNTE, CLISTN, COEFN )
...
C 16 May 2008 Scott Hannon   Add NJUNK to prevent adjusting 7th nonNTE
C                               coef
C 02 Nov 2008 Scott Hannon   Bug fix: NJUNK wrong

!END====================================================================

C      =================================================================
       SUBROUTINE TUNMLT ( IOUN, NCHAN, INDCHN, SETCHN,
